...
urlpatterns = [
    ...
    path('product_category_store',views.product_category_store,name='product_category_store'),
    #--------------------------------------------------------------------------------
    path('showAllcategories',views.showAllcategories,name='showAllcategories'),
    ...
    #--------------------------------------------------------------------------------
    path('product_subcategory', views.product_subcategory, name='product_subcategory'),
    path('product_subcategory_store',views.product_subcategory_store,name='product_subcategory_store'),
    #--------------------------------------------------------------------------------
    
    path('showAllsubcategory',views.showAllsubcategory,name='showAllsubcategory'),
    # path('categoryedit/<int:id>',views.categoryedit,name="categoryedit"),
    # path('category_update/<int:id>',views.category_update,name="category_update"),
    # path('category_delete/<int:id>',views.category_delete,name="category_delete"),
